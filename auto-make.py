...
# intialize the investment amount.
myAccount = BLQ_InvestmentCalaculator(100000)

# myAccount._weekly_profit()
print(myAccount._calculate_monthly_profit())